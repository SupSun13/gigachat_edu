...
GROUP_ID = int(os.getenv('GROUP_ID', '240322029'))
...
# Настройки GigaChat
GIGACHAT_MODEL = "GigaChat-2"  # Для Freemium: GigaChat-2 (Lite), GigaChat-2-Pro, GigaChat-2-Max
...
def main():
    ...
    print(f"🤖 Модель GigaChat: {GIGACHAT_MODEL}")
